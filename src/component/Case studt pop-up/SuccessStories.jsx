...
import CallingIcon from '../../images/calling.svg'
...
function SuccessStories({ onVerify, isOpen, onClose, caseStudyId, type  }) {
    ...
    return (
        ...
        {/* <div className="modal-overlay"> */}
            ...
            <form className="card" onSubmit={handleSubmit} onClick={(e) => e.stopPropagation()} >
                ...
                <div className="recaptcha" style={{margin:0}}>
                    {/* <div>
                        <input
                            ...
                            onChange={handleChange}
                            onBlur={handleBlur}
                            style={{ height: '19px', width: '21px', marginLeft: '25px' }}
                        />
                        <label style={{ marginLeft: '10px' }} htmlFor="recaptcha">I'm not a robot</label>
                    </div> */}
                ...
                <div className='close-btn' onClick={onClose}>Cancel</div>
                <button type="submit" className="submit-btn">Download Now</button>
                </div>
